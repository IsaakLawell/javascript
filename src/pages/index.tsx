  ...
  return (
    <>
      ...
      <main className="h-screen">
        <div className="fixed h-1/2 w-screen top-0 left-0 bg-gradient-to-b from-blue-500 via-pink-400 to-white z-[-1]"></div>
        <div className="fixed h-1/2 w-screen top-1/2 left-0 bg-gradient-to-t from-blue-500 via-pink-400 to-white z-[-1] "></div>
